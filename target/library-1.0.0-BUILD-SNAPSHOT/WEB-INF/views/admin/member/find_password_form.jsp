...
<link href="<c:url value='/201921031/resources/css/admin/find_password_form.css' />" rel="stylesheet" type="text/css">
	...
	<section>
		...
		<div id="section_wrap">
			...
			<div class="find_password_form">
				...
				<form action="<c:url value='/201921031/admin/member/findPasswordConfirm' />" name="find_password_form" method="post">
			...
			<div class="create_account_login">
				...
				<a href="<c:url value='/201921031/admin/member/createAccountForm' />">create account</a>
				<a href="<c:url value='/201921031/admin/member/loginForm' />">login</a>
